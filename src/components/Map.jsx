...
// Create red marker icon for location (Google Maps style)
const createLocationMarker = () => {
  return L.divIcon({
    html: `<svg width="32" height="41" viewBox="0 0 32 41" xmlns="http://www.w3.org/2000/svg">
      <path d="M16 0C7.163 0 0 7.163 0 16c0 9 16 25 16 25s16-16 16-25c0-8.837-7.163-16-16-16z" fill="#FF0000"/>
